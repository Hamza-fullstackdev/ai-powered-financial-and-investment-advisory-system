      ...
      <div className='w-[90%] mx-auto'>
        <div>
          <h1 className='font-bold text-5xl text-center leading-tight'>
            Ai Powered{" "}
            <span className='text-green-600'>Financial and Investment</span>{" "}
            Advisory System
          </h1>
        </div>
        <div className='mt-12 grid grid-cols-1 md:grid-cols-3 items-center gap-10'>
          <div>
            <p className='text-gray-700'>
              Our platform delivers personalized financial insights, portfolio
              strategies, and real-time market analysis.
            </p>
